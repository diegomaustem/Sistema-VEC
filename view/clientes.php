...
if(isset($_SESSION['usuario'])){
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmClientes">
						<label>Nome</label>
						<input type="text" class="form-control input-sm" id="nome" name="nome" placeholder="Nome">
						<label>Sobrenome</label>
						<input type="text" class="form-control input-sm" id="sobrenome" name="sobrenome" placeholder="Sobrenome">
						<label>Endereço</label>
						<input type="text" class="form-control input-sm" id="endereco" name="endereco" placeholder="Endereço">
						<label>Email</label>
						<input type="text" class="form-control input-sm" id="email" name="email" placeholder="E-mail">
						<label>Telefone</label>
						<input type="text" class="form-control input-sm" id="telefone" name="telefone" placeholder="Telefone">
						<label>CPF</label>
						<input type="text" class="form-control input-sm" id="cpf" name="cpf" placeholder="Cpf">
						<p></p>
	...
	<!-- Metodo Ajax onde envia as informações do Id para ObterDadosCliente  -->
	<script type="text/javascript">
