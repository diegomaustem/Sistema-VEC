			...
			<div class="row">
				<div class="col-sm-4">
					<form id="frmProdutos" enctype="multipart/form-data">
						...
						<label>Nome</label>
						<input type="text" class="form-control input-sm" id="nome" name="nome" placeholder="Nome produto ">
						<label>Descrição</label>
						<input type="text" class="form-control input-sm" id="descricao" name="descricao" placeholder="Descrição produto">
						<label>Quantidade</label>
						<input type="text" class="form-control input-sm" id="quantidade" name="quantidade" placeholder="Quantidade produto">
						<label>Preço</label>
						<input type="text" class="form-control input-sm" id="preco" name="preco" placeholder="Preço produto">
						<label>Imagem</label>
